...
class EditStudent extends EditRecord
{
        ...
        Step::make('Identitas Ayah')
            ->schema([
                Select::make('status_ayah')
                    ->label('Status Ayah')
                    ->options(JenisStatus::all()->pluck('name','id'))
                    ->reactive()
                    ->required(),  
    ...
    {
        $student = Student::where('user_id', $data['user_id'])->with('indonesia_village.district.city.province')->first();
        // $data['user_id'] = auth()->id();
        // $data['village_id'] = $student->indonesia_village->id;
        $data['district_id'] = $student->indonesia_village->district->id;
        $data['city_id'] = $student->indonesia_village->district->city->id;
        $data['province_id'] = $student->indonesia_village->district->city->province->id;
